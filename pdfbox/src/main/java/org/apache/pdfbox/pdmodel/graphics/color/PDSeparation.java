...
public class PDSeparation extends PDSpecialColorSpace
{
    ...
    //
    @Override
    public BufferedImage toRGBImage(WritableRaster raster, PDColorSpace targeColorSpace) throws IOException
    {
        ...
        return alternateColorSpace.toRGBImage(altRaster, targeColorSpace);
    }
